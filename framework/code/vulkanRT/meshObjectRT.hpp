...
public:
    ...
    bool Create(Vulkan& vulkan, VulkanRT& vulkanRT, const MeshObjectIntermediate& meshObject, bool allowDataAccess = false, UpdateMode updateMode = UpdateMode::NotUpdatable);
    ...
    static Buffer<Vulkan> CreateRtVertexBuffer(MemoryManager<Vulkan>& memoryManager, const MeshObjectIntermediate& meshObject, BufferUsageFlags usageFlags = BufferUsageFlags::AccelerationStructureBuild|BufferUsageFlags::ShaderDeviceAddress);
