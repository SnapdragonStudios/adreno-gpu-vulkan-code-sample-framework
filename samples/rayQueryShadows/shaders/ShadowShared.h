...
#ifndef _SHADOWSHARED_H_
#define _SHADOWSHARED_H_
...
#ifndef SHADOW_VARIANCE_DISTANCE_ATTEN_DISABLE
#define SHADOW_VARIANCE_DISTANCE_ATTEN_DISABLE 0
#endif // SHADOW_VARIANCE_DISTANCE_ATTEN_DISABLE
...
#if SHADOW_VARIANCE_DISTANCE_ATTEN_DISABLE
    return max(edgeFade, Variance / (Variance + (Distance * Distance)));
#else
    return max(edgeFade, Variance);
#endif // SHADOW_VARIANCE_DISTANCE_ATTEN_DISABLE
}
