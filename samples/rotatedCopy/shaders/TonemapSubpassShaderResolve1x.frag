...
layout (input_attachment_index = SHADER_DIFFUSE_SUBPASS_INPUT, binding = SHADER_DIFFUSE_TEXTURE_LOC) uniform subpassInput u_DiffuseInput;
...
//-----------------------------------------------------------------------------
{
    ...
    // Texture Colors
    // ********************************
    // Load subpass color input.
    vec4 DiffuseColor0 = subpassLoad( u_DiffuseInput );
